        ...
        if (!empty($_POST['certificates'])) {
            foreach ($_POST['certificates'] as $certificateId) {
                $stmt = $conn->prepare("INSERT INTO referee_certificate (RefereeID, CertificateID, IssueDate, ExpiryDate)
                                       VALUES (:referee_id, :certificate_id, :issue_date, :expiry_date)");
...
<body>
    ...
    <div class="player-content">
        <div class="player-form-wrapper">
            ...
            <form method="post" action="addreferee.php">
                ...
                <input type="number" id="pay_per_hour" name="pay_per_hour" min="0" step="0.01" required>
